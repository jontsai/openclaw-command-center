...
var require_tokens = __commonJS({
  "src/tokens.js"(exports2, module2) {
    ...
    async function refreshTokenUsageAsync2(getOpenClawDir2) {
      ...
      try {
        const sessionsDir = getTokenSessionsDir(getOpenClawDir2);
...
var require_fleet = __commonJS({
  "src/fleet.js"(exports2, module2) {
    ...
    function runUrlCheck(check = {}) {
      ...
      const timeoutSeconds = Math.max(1, Math.ceil((check.timeoutMs || DEFAULT_TIMEOUT_MS) / 1e3));
    ...
    function checkCommandCenter(commandCenter = {}) {
      if (commandCenter.version || commandCenter.installed === true || commandCenter.type === "static") {
        return {
    ...
    function getFleetAgents2(config) {
    ...
    module2.exports = {
      getFleetAgents: getFleetAgents2,
      runCommandCheck,
      runUrlCheck,
      checkGateway,
      checkCommandCenter
  ...
  "src/state.js"(exports2, module2) {
    ...
    function createStateModule2(deps) {
      ...
      function getFullState() {
        ...
        try {
          fleet = getFleetAgents2 ? getFleetAgents2(CONFIG2) : [];
        } catch (e) {
          console.error("[State] fleet:", e.message);
        }
        try {
...
var { getFleetAgents } = require_fleet();
