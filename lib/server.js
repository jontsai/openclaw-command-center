...
var require_openclaw = __commonJS({
  "src/openclaw.js"(exports2, module2) {
    ...
    function runOpenClaw2(args2) {
      ...
      try {
        const result = execSync(`openclaw${profileFlag} ${args2}`, {
          encoding: "utf8",
          timeout: 3e3,
  ...
  "src/vitals.js"(exports2, module2) {
    ...
    async function refreshVitalsAsync() {
      ...
      try {
        ...
        const [hostname, uptimeRaw, coresRaw, memTotalRaw, memInfoRaw, dfRaw, topOutput] = await Promise.all([
        ...
        const iostatCmd = isLinux ? "timeout 5 iostat -d -o JSON 1 2 2>/dev/null || echo ''" : "iostat -d -c 2 2>/dev/null | tail -1 || echo ''";
  ...
  "src/sessions.js"(exports2, module2) {
    ...
    function createSessionsModule2(deps) {
      ...
      async function refreshSessionsCache() {
        ...
        try {
          const output = await runOpenClawAsync2("sessions list --json 2>/dev/null");
      ...
      function getSessions(options = {}) {
        ...
        try {
          const output = runOpenClaw2("sessions list --json 2>/dev/null");
          const jsonStr = extractJSON2(output);
          if (jsonStr) {
            const data = JSON.parse(jsonStr);
      ...
      function getSessionDetail(sessionKey) {
        try {
          const listOutput = runOpenClaw2("sessions list --json 2>/dev/null");
...
var require_tokens = __commonJS({
  "src/tokens.js"(exports2, module2) {
    ...
    function getCostBreakdown2(config, getSessions) {
      ...
      try {
        switch (action) {
          ...
          case "gateway-restart":
            ...
            break;
          case "sessions-list":
            results.output = runOpenClaw2("sessions list 2>&1") || "No sessions";
            results.success = true;
            break;
          case "cron-list":
          ...
          case "health-check": {
            ...
            const sessions2 = runOpenClaw2("sessions list --json 2>&1");
            let sessionCount = 0;
            try {
          ...
          case "clear-stale-sessions": {
            const staleOutput = runOpenClaw2("sessions list --json 2>&1");
            let staleCount = 0;
            try {
...
To clean: openclaw sessions prune`;
    ...
    module2.exports = { executeAction: executeAction2 };
  }
});
  ...
  "src/state.js"(exports2, module2) {
    ...
    function createStateModule2(deps) {
      ...
      function getFullState() {
        ...
        try {
          tokenStats = getTokenStats2(sessions2, capacity);
        } catch (e) {
...
var { getSystemVitals } = require_vitals();
var { checkAuth, getUnauthorizedPage } = require_auth();
var { loadPrivacySettings, savePrivacySettings } = require_privacy();
var { loadOperators, saveOperators, getOperatorBySlackId, startOperatorsRefresh } = require_operators();
...
server.listen(PORT, () => {
  ...
  const SESSIONS_CACHE_TTL = 1e4;
  const TOKEN_USAGE_CACHE_TTL = 3e4;
